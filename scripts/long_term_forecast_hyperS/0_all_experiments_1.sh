...
bash ./scripts/long_term_forecast_hyperS/ETT_script/Crossformer_ETTh1.sh > ./log_20240909/ETT_script_Crossformer_ETTh1
bash ./scripts/long_term_forecast_hyperS/ETT_script/Autoformer_ETTh1.sh > ./log_20240909/ETT_script_Autoformer_ETTh1 
bash ./scripts/long_term_forecast_hyperS/ETT_script/Nonstationary_Transformer_ETTh1.sh > ./log_20240909/ETT_script_Nonstationary_Transformer_ETTh1
bash ./scripts/long_term_forecast_hyperS/ETT_script/TimeMixer_ETTh1.sh > ./log_20240909/ETT_script_TimeMixer_ETTh1
...
bash ./scripts/long_term_forecast_hyperS/ETT_script/iTransformer_ETTh1.sh > ./log_20240909/ETT_script_iTransformer_ETTh1 
bash ./scripts/long_term_forecast_hyperS/ETT_script/Transformer_ETTh1.sh > ./log_20240909/ETT_script_Transformer_ETTh1 
...
bash ./scripts/long_term_forecast_hyperS/Weather_script/iTransformer.sh > ./log_20240909/Weather_script_iTransformer 
